        ...
        <div className="flex justify-start md:flex-row flex-col md:gap-0 gap-4">
          ...
          ">
            <input onChange={handleInputChange} value={query}
              ...
              className="block flex-1 border-0 bg-transparent py-1.5 pl-7  text-gray-900 placeholder:text-gray-400 focus:right-0 sm:text-sm sm:leading-6"
            />
          ...
          <button className="bg-blue text-white py-2 px-10 md:rounded-s-none rounded ">Search</button>
        </div>
      </form>
      </div>
